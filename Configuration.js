...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Estanque Aromatico", endpointType.volumeSensor);
  endpoints.addEndpoint("2", "Estanque Aguarras Mineral (E2)", endpointType.volumeSensor);
  endpoints.addEndpoint("3", "Estanque Aguarras Mineral (E3)", endpointType.volumeSensor);
  endpoints.addEndpoint("4", "Estanque solvente recuperado", endpointType.volumeSensor);
  endpoints.addEndpoint("5", "Estanque Soya", endpointType.volumeSensor);
  endpoints.addEndpoint("6", "Estanque Xilol **** MANTENIMIENTO *****", endpointType.volumeSensor);
}
