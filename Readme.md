...
# Configuration Script – ezegen1pag - Rev. B

This **Configuration** script is designed for the **ezegen1pag** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – ezegen1pag Rev. B

Este script de **Configuration** está diseñado para el modelo **ezegen1pag** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
